...
if q2_answer == "a":
    ...
    print("Want to live your life as an outcast, do you?")
q3_answer = input("\n Chose a hero: \na) Newt Scamander \nb) Albus Dumbledore \nc) Fred Weasley \nd) Luna Lovegood \ne) Severus Snape \nf) Regulus Black\n\n")
if q3_answer == "a":
    Hufflepuff += 1
elif q3_answer == "b":
...
if ((Gryffindor > Hufflepuff and Gryffindor > Ravenclaw and Gryffindor > Slytherin) and (Hufflepuff > Ravenclaw or Hufflepuff > Slytherin)):
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("GRYFFINPUFF!", align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("GRYFFINCLAW!", align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("GRYFFERIN!", align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("HUFFLECLAW!", align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("HUFFLEDOR!", align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("HUFFERIN!", align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("RAVERINN!", align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("RAVERDOR!", align="center",font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("RAVERPUFF!", align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("SLYTHERPUFF!", align="center",font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("SLYTHERCLAW!",  align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
    ...
    for x in range(200):
      ...
      t.pendown()
      t.write("SLYTHERDOR!", align="center", font = ("Arial", "50", "bold"))
      time.sleep(0.25)
else:
